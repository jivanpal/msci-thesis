...
\lstinputlisting[language=Bash,caption={Shell script to determine critical points — \code{undervolt-test.sh}}]{undervolt-test.sh}
% \inputminted{bash}{methodology/undervolt-test.sh}
